...
>
> **📦 庫存見底自動補:** 若下面已經沒有任何 `[ ]` 未寫的,寫文前先自動補庫存——WebSearch 找一批(≥10 篇)沒收錄過的 HBR 經典,查證作者/年份後照本格式 append(append 前比對整份帳本 + `site/idea/_articles.php`,已收錄/已寫的絕不重複),補完再挑一篇寫。不必為「空了」中途問山姆。
>
