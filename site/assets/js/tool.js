...
(function () {
  ...
  var AXES = [
    ...
    { key:'I', name:'你怎麼介入?', en:'Intervention',
      note:'重點不是功能多,是有沒有把那個最關鍵的摩擦變輕。',
      weak:{ title:'介入點,還不夠鋒利',
        body:'先講清楚一件事:你讓哪一個「會讓人放棄」的卡點,幾乎消失了?不是功能比別人多,是那個最痛的摩擦變輕了。',
        quote:'不是功能多,是痛變輕。' },
      strong:'你說得出一個被你變輕的關鍵摩擦,而且那是你做得成的事。',
      qs:[
        { id:'i1', text:'你的解法,把哪一個「最關鍵的摩擦」變輕了?', opts:[
          { t:'我還說不太清楚', s:20, unsure:true },
          { t:'主要是功能比別人多', s:40 },
          { t:'我講得出一個被變輕的關鍵摩擦', s:85 },
          { t:'那個摩擦本來讓人放棄,我讓它幾乎消失', s:100 } ]},
