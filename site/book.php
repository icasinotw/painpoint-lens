...
$faqs = [
  ...
  [
    'q' => '買了之後,有沒有讀者專屬的東西?',
    'a' => '有。買過的讀者可以免費領一份讀者好禮:《痛點》讀者精選拆書 15 篇——我用書裡同一把 P.A.I.N. 之尺,拆過最經典的 15 本商業書(精實創業、定位、黑天鵝、致富心態……),照書的 P→A→I→N 順序整理成一份 PDF。到 painpoint.tw/claim 留個 email、填一下在哪買的,我就寄給你。',
  ],
  [
    'q' => '買了之後想退怎麼辦?',
