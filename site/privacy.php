...
<main class="wrap-read" style="padding-block:48px 64px">
  ...
  <div class="reading" style="font-size:1.05rem;line-height:1.95;padding-block:8px">
    <p>這份政策說明「痛點 P.A.I.N.」(本網站)如何蒐集、使用與保護你的個人資料。我們盡量只收必要的、誠實地用它。最後更新:2026 年 6 月 30 日。</p>

    <h2>一、我們蒐集什麼</h2>
    <p><strong>你主動提供的 email：</strong>當你為了匯出 PDF、儲存多個點子或把報告寄到信箱而留下 email 時,我們會記錄它。<br>
    <strong>購書憑證資訊：</strong>當你到「<a href="/claim">領讀者好禮</a>」頁面領取讀者專屬好禮時,我們會記錄你填寫的<strong>購買平台</strong>(你在哪裡買的)與<strong>訂單編號</strong>(選填)。這些只用來確認你是《痛點》的讀者,不會用於其他目的。<br>
    ...
    <h2>二、我們用來做什麼</h2>
    <p>寄送你要求的體檢結果;寄送「痛點電子報」(動手前先想清楚的方法與真實案例);確認購書讀者身分並寄送讀者專屬好禮;以及偶爾分享《痛點》電子書的消息與更新。僅此而已。我們<strong>不會販售或出租</strong>你的個資給第三方。</p>
